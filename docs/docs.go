    ...
    "paths": {
        "/building": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "items: array of Building",
                        "schema": {
                            "type": "object",
        ...
        "/building/{id}/project-section": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "items: array of ProjectSection",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Project Section data",
                        "name": "section",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ProjectSection"
                        }
                    }
                ],
                "responses": {
        ...
        "/building/{id}/project-section/{section_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Project Section ID",
                        "name": "section_id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/customer": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "items: array of Customer",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/equipment": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "items: array of Equipment",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/file": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "items: array of File",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/floor": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "items: array of Floor",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/health": {
            "get": {
                "description": "Проверить состояние API",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/opc/datatype": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "items: array of OPCDatatype",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.OPCDatatype"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/opc/server": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "items: array of OPCServer",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.OPCServer"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/opc/tag": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "items: array of OPCTag",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/setting": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "items: array of Setting",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/zone": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "items: array of Zone",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "models.Equipment": {
            ...
            "properties": {
                "binds": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.EquipmentBind"
                    }
                },
                "building": {
                    "$ref": "#/definitions/models.Building"
                ...
                "devices": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.EquipmentDevice"
                    }
                },
                "enabled": {
                    "type": "boolean"
                ...
                "entity": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/models.EquipmentEntity"
                        }
                    ]
                },
                "entity_id": {
                ...
                "limits": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.EquipmentLimit"
                    }
                },
                "modified": {
                    "type": "string"
